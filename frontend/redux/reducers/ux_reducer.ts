...
import { AUTH_ERRORS } from "shared/utility/errorMessages";
import { Session, ReduxAction, Ui } from "shared/utility/types";
...
export const authErrorsReducer = (
  state: any = {},
  { type, payload }: ReduxAction
) => {
  Object.freeze(state);
...
export const courseErrorsReducer = (
  state: any = {},
  { type, payload }: ReduxAction
) => {
  Object.freeze(state);
